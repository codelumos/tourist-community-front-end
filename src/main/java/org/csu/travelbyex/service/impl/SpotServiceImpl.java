...
public class SpotServiceImpl implements SpotService {
    ...
    public LargePlace getLPByName(String lpName){
        ...
        List list = largePlaceMapper.selectByExample(largePlaceExample);
    ...
    public List getLPs(Boolean inHome){
        ...
        return largePlaceMapper.selectByExample(largePlaceExample);
    }
    ...
    public SmallPlace getSPByName(String spName){
        ...
        List list = smallPlaceMapper.selectByExample(smallPlaceExample);
    ...
    public List getSPsByLPid(Integer lpId){
        ...
        return smallPlaceMapper.selectByExample(smallPlaceExample);
    }
    ...
    public ScenicSpot getScenicSpotByName(String spotName){
        ...
        List list = scenicSpotMapper.selectByExample(smallPlaceExample);
    ...
    public List getScenicSpotsBySPid(Integer spId){
        ...
        return scenicSpotMapper.selectByExample(smallPlaceExample);
    }
